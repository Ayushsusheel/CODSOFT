...
<body style="background-color:powderblue;">
 		 ...
 		 <video autoplay loop muted plays-inline class="backVideo">
			...
			<source src="<c:url value= "/resources/images/mountainRoad.mp4" /> " type="video/mp4"  >	
	  ...
	  <h1 class="text-center mt-5"> __Add Students Here__ </h1> 
	    ...
	    <form action="processForm" method ="post">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
					  ...
					  <select name="subjects[]" 
					   ...
					   <small id="emailHelp" class="form-text text-muted">please make ensure to assign at least 4 subjects...</small>
			  ...
			  <div class="container mt-5 text-center">
			  		 ...
			  		 <a href="${pageContext.request.contextPath}/generateEmail" class = "btn btn-outline-warning" >Generate Email</a>
