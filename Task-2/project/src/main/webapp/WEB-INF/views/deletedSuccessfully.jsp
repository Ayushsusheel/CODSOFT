...
<html lang="en">
    ...
    <head>
        ...
        <!--  <title>Success :-))</title> it will fetch my value from Base.jsp file-->
    ...
    <body>
        ...
        <div class="vh-100 d-flex justify-content-center align-items-center">
            <div class="col-md-4">
                ...
                <div class="card  bg-white shadow p-5">
                    ...
                    <div class="text-center">
                        <h1>Deleted Successfully !</h1><br><hr>
                        <p>${NAME}'s Data Deleted Successfully from the Database !</p>
         ...
         <div class="container mt-5 text-center">
			  		 ...
			  		 <a href="${pageContext.request.contextPath}/" class = "btn btn-outline-primary" >HOME-PAGE</a>	
